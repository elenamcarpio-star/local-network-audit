...
1. Descargar y ejecutar `nmap-7.98-setup.exe`, la descarga debe de estar en la misma carpeta que los ficheros ejecutar.bat y escaner_pro.ps1
...
1. Clic derecho sobre `ejecutar.bat`
2. Seleccionar **"Ejecutar como administrador"** (o hacer doble clic, el propio .bat solicitará privilegios automáticamente)
3. Aceptar la ventana de UAC
4. Esperar a que finalice el escaneo (puede tardar varios minutos según el número de equipos en la red)
5. El informe se generará automáticamente en la misma carpeta
